...
You can find in-depth instructions to install the correct Node modules and Ruby gems, and to set up the project in our [README](https://github.com/emeraldion/aoi/blob/master/README.md#development).

## Reporting a bug

So you've found a bug, and want to help us fix it? Before filing a bug report, please double-check the bug hasn't already been reported. You can do so [on our issue tracker](https://github.com/emeraldion/aoi/issues?q=is%3Aissue+is%3Aopen+label%3Abug). If something hasn't been raised, you can go ahead and create a new issue with the following information:
...
We've got a few open issues and are always glad to get help on that front. You can view the list of issues [here](https://github.com/emeraldion/aoi/issues). Most of the issues are labelled, so you can use the labels to get an idea of which issue could be a good fit for you. (Here's [a good article](https://medium.freecodecamp.com/finding-your-first-open-source-project-or-bug-to-work-on-1712f651e5ba) on how to find your first bug to fix).
...
- **bidi**: This means that the issue is specific to bidirectional languages, e.g. Arabic or Hebrew, that render text from right to left.
